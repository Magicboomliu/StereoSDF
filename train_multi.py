...
from trainfiles.trainer_stereo_multi import DisparityTrainer
...
if __name__ == '__main__':
    ...
    parser.add_argument('--new_datapath', type=str, help='provide the root path of the data', default='/spyder/sceneflow/')
